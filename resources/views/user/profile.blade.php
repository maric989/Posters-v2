                                        ...
                                        <div class="text">
                                            <div class="outer">
                                                ...
                                                <div class="counter-item" style="margin-right: 30px">
                                                    ...
                                                    <span class="number">{{$user->getPosterLikes() + $user->getDefinitionLikes()}}</span><br/>
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="main-wrap">
                                ...
                                <!-- Tab links -->
                                <div class="tab">
                                    <button class="tablinks active" onclick="openCity(event, 'London')">Posteri</button>
                                    <button class="tablinks" onclick="openCity(event, 'Paris')">Definicije</button>
                                </div>
                                            ...
                                            <div class="article-top">
                                                ...
                                                <div class="counters-line">
                                                    <div class="pull-left">
                                                        ...
                                                        <div class="user"><i class="icon-user"></i> <a href="{{route('user.profile',$user->slug)}}">{{$user->name}}</a></div>
                                                        <div class="comments"><i class="icon-comments"></i> <a href="{{route('single.poster',[$poster->slug,$poster->id])}}">{{$poster->getComments($poster->id)->count()}}</a></div>
                                                    </div>
